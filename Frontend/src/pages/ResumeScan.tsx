  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50 p-6">
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mb-16">
          <div className="border-gradient-to-r relative rounded-3xl border-2 bg-gradient-to-br from-red-200 from-white/90 via-pink-200 via-pink-50/90 to-purple-200 to-purple-50/90 p-8 shadow-2xl backdrop-blur-xl">
        ...
        {/* Bottom Features Section - Full Width */}
        <div className="border-gradient-to-r rounded-3xl border-2 bg-gradient-to-br from-gray-200 from-white/90 via-gray-50/90 via-pink-200 to-pink-50/90 to-purple-200 p-8 shadow-2xl backdrop-blur-xl">
          <div className="mb-8 text-center">
            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-r from-gray-700 via-pink-600 to-purple-600 shadow-lg">
              <svg
                className="h-8 w-8 text-white"
                fill="none"
                stroke="currentColor"
            ...
            <h3 className="mb-4 bg-gradient-to-r from-gray-700 via-pink-600 to-purple-600 bg-clip-text text-3xl font-bold text-transparent">
              What You'll Get from Resume Analysis
            </h3>
            <p className="text-lg font-medium text-gray-700">
              Comprehensive insights to transform your resume into a job-winning
              document
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Overall Score",
                description:
                  "Get a comprehensive score based on industry standards",
              ...
              },
              {
                ...
                description:
                  "Detailed breakdown of each resume section performance",
              ...
              },
              {
                ...
                description:
                  "Comprehensive analysis report with visual insights",
            ...
            {[
              {
                ...
                label: "Lightning Fast Analysis",
              },
              {
                icon: "🎯",
                stat: "98% Accuracy",
                label: "Industry-Leading Precision",
              },
              {
                icon: "🔐",
                stat: "Bank-Level Security",
                label: "Your Privacy Protected",
              },
            ].map((item, idx) => (
              <div key={idx} className="text-center">
